...
public class UpdateUserController extends HttpServlet {
    ...
    public void saveUser(HttpServletRequest request, HttpServletResponse response)
        ...
        // NHẬN CHUỖI BASE64: Nhận như một String thông thường từ thẻ hidden
        String avatarBase64 = request.getParameter("avatarBase64");
        if (avatarBase64 == null || avatarBase64.trim().isEmpty()) {
            avatarBase64 = "images/default-avatar.png"; // Ảnh mặc định nếu không chọn
        }
        ...
        String url = "";
        UserDTO user = new UserDTO(userID, fullName, password, roleID, status,avatarBase64);
        request.setAttribute("userInput", user);
        request.setAttribute("update", true);
        if (checkError) {
            url = "user-form.jsp";
